...
static const char *fonts[]          = { "JetBrains Mono SemiBold:size=12" , "Noto Color Emoji:size=12" };
static const char dmenufont[]       =	"JetBrains Mono Semibold:size=12";
...
{ "background_process",NULL,       NULL,	1 << 8,	       	0,          -1 },
...
static const char *volumekeys[][8] = {{"wpctl" ,"set-mute" ,"@DEFAULT_AUDIO_SINK@" ,"toggle",NULL}, {"wpctl" , "set-volume" ,"-l", "1" ,"@DEFAULT_AUDIO_SINK@" ,"5%+",NULL},{"wpctl" ,"set-volume" ,"@DEFAULT_AUDIO_SINK@" ,"5%-", NULL}};
